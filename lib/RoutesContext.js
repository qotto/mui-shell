...
exports.RoutesProvider = undefined;
...
var RoutesContext = _react2.default.createContext();
...
var getExactMatch = function getExactMatch(pathname) {
  return function (route) {
    return (0, _reactRouterDom.matchPath)(pathname, { path: route.path, exact: true });
  };
};
...
}(_react2.default.PureComponent), _class.getDerivedStateFromProps = function (_ref, state) {
...
exports.RoutesProvider = RoutesProvider = (0, _reactRouterDom.withRouter)(RoutesProvider);
