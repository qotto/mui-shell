...
var Breadcrumb = (_temp2 = _class = function (_PureComponent) {
  ...
  return Breadcrumb;
}(_react.PureComponent), _class.getDerivedStateFromProps = function (props, state) {
...
exports.default = (0, _reactRouterDom.withRouter)((0, _styles.withStyles)(styles)(Breadcrumb));
