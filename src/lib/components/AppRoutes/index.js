    ...
    return (
      <RoutesContext.Consumer>
        {({ currentRoute, currentMatch, lastRoute, routes }) => {
          ...
          const animationClassNames = `scene-${getAnimation(currentRoute, lastRoute)}`;
          if (!currentRoute) {
          ...
          return (
            <TransitionGroup component={null} childFactory={this.transitionChildFactory(animationClassNames)}>
              <CSSTransition classNames={animationClassNames} key={currentRoute.label} timeout={200}>
